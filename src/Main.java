...
class Main {
    ...
    public static void main(String[] args) {
        ...
        LinkedList<Robot> pos = new LinkedList<Robot>();
        ...
        View view = new View();
        view.setRobot(pos);
        Controller controller = new Controller(view, threadOutputQueue, robotsAndPositionOffsets,random);
        controller.startRobotThreads(5000);
